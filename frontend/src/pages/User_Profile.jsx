...
export default function UserProfile() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      {feedback.message && (
        <div
          className={`p-3 rounded mb-6 text-center ${
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1 text-center flex flex-col items-center bg-white p-6 rounded-lg shadow-md">
          ...
          <button
            ...
            disabled={isLoading}
            className="mt-4 px-5 py-2 bg-blue-600 text-white font-medium rounded-lg shadow-md hover:bg-blue-700 transition disabled:opacity-50"
          >
        ...
        <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-md">
          <form onSubmit={handleProfileUpdate} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-green-600 text-white px-5 py-3 rounded-lg shadow-md hover:bg-green-700 transition disabled:opacity-50"
            >
